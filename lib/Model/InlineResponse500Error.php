...
/**
 * InlineResponse500Error Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse500Error implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_500_error';
     ...
     * Sets param
     *
     * @param string $param Parameter the error message is related to `null` is the error is generic
     *
     * @return $this
     */
