...
class CreateWebhook implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sms_notification_url'] === null) {
            $invalidProperties[] = "'sms_notification_url' can't be null";
        }
        if ($this->container['sms_notification_method'] === null) {
            $invalidProperties[] = "'sms_notification_method' can't be null";
        }
